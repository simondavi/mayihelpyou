...
We were particularly interested whether reliability improves if an item is dropped and if that might as well improve model fit. Alpha could not be improved in case of *Professional Relationships*... 
...
model_inf_sup <- '
  ...
  # Simple Slopes: X at designated levels of Z
...
model_ins_sup <- '
  ...
  # Measurement model: Instrumental support
